...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 11, 0, 
		...
		XYREF(Button_Minus, 28, 169),
		XYREF(InputNumber_Tagesziel, 13, 424),
		XYREF(InputNumber_Gesamtziel, 200, 424),
		XYREF(Meter_Gesamtzaehler, 10, 240),
		XYREF(Meter_Tageszaehler, 10, 240),
		XYREF(Container_Ziel_erreicht, 213, 199),
	ID(DataMask_1001), TYPEID_DATAMASK, COLOR(230), ID(ID_NULL), 0, 0, 
	...
	ID(Container_3002), TYPEID_CONTAINER, WORD(67), WORD(52), 0, 1, 0, 
		XYREF(Rectangle_14000, 0, 0),
	ID(Container_Ziel_erreicht), TYPEID_CONTAINER, WORD(143), WORD(100), 1, 2, 0, 
		XYREF(Container_3002, 0, 0),
		XYREF(InputString_8000, 2, 4),
	...
	ID(SoftKey_PlusPlus), TYPEID_SOFTKEY, COLOR(187), 1, 1, 0, 
		XYREF(OutputString_PlusPlus, -1, 14),
	...
	ID(SoftKey_Minus), TYPEID_SOFTKEY, COLOR(70), 1, 1, 0, 
		XYREF(OutputString_11007, 0, 3),
	...
	ID(Button_Minus), TYPEID_BUTTON, WORD(155), WORD(55), 249, 249, 1, 0, 1, 0, 
		XYREF(OutputString_11006, -4, 14),
	ID(InputString_8000), TYPEID_INSTR, WORD(141), WORD(97), COLOR_RED, ID(FontAttributes_23003), 
		ID(ID_NULL), 2, ID(ID_NULL), 0, 28, 'F', 'e', 'i', 'e', 'r', 'a', 'b', 'e', 'n', 'd', ' ', ' ', ' ', ' ', 'B', 'i', 'e', 'r', ' ', 't', 'r', 'i', 'n', 'k', 'e', 'n', '!', '!', 1, 0, 
	ID(InputNumber_Tagesziel), TYPEID_INNUM, WORD(173), WORD(33), COLOR(100), ID(FontAttributes_Default), 0, 
		ID(NumberVariable_Tagesziel), LONG(123UL), LONG(0UL), LONG(65535UL), LONG(0L), FLOAT_1, 0, 0, 2, 1, 0, 
	ID(InputNumber_Gesamtziel), TYPEID_INNUM, WORD(87), WORD(39), COLOR(20), ID(FontAttributes_Default), 0, 
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(80), WORD(40), COLOR_WHITE, ID(FontAttributes_Button), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_11006), TYPEID_OUTSTR, WORD(155), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 1, WORD(12), 'F', 'a', 's', 's', ' ', 'w', 'e', 'n', 'i', 'g', 'e', 'r', 0,
	ID(OutputString_11007), TYPEID_OUTSTR, WORD(75), WORD(74), COLOR_WHITE, ID(FontAttributes_Default), 1,
		ID(ID_NULL), 1, WORD(5), 'M', 'i', 'n', 'u', 's', 0,
	...
	ID(Rectangle_14000), TYPEID_OUTRECT, ID(LineAttributes_24000), 
		WORD(67), WORD(52), 0, ID(FillAttributes_25000), 0, 
	...
	ID(FontAttributes_23003), TYPEID_FONTATTR, COLOR_BLACK, 5, 0, 0, 0, 
